# Install Watson Discovery Service on Cloud Pak for Data

Module to install Watson Discovery service on Cloud Pak for Data. As per instructions mentioned in 
https://www.ibm.com/docs/en/cloud-paks/cp-data/4.0?topic=discovery-installing-watson
...
```hcl-terraform
module "cp-watson-discovery" {
  source = "github.com/cloud-native-toolkit/terraform-gitops-cp-watson-discovery"
